...
int main()
{
    ...
    create("input.txt", animals, track);
 ...
 */
//////////////////////////////////////////////////////////////////////
    create("inp11.txt", animals, track);
    race(animals, track, highest);
    ...
    create("inp12.txt", animals, track);
    race(animals, track, highest);
    CHECK(highest.size() == 10);
    destroy(animals);
    highest.clear(); track.clear();

    create("inp13.txt", animals, track);
    race(animals, track, highest);
    CHECK(highest.size() == 10);
    destroy(animals);
    highest.clear(); track.clear();

    create("inp14.txt", animals, track);
    race(animals, track, highest);
...
TEST_CASE("3", "Outer Loops")
{
    ...
    vector<string> highest;
*/
    create("inp21.txt", animals, track);
    ...
    create("inp22.txt", animals, track);
    ...
    create("inp23.txt", animals, track);
 ...
 */
   ...
   //one animal prevails other next round
    ...
    create("inp31.txt", animals, track);
    race(animals, track, highest);
   ...
   //no max element exists
    highest.clear(); track.clear();
    create("inp32.txt", animals, track);
    race(animals, track, highest);
    CHECK(highest.size() == 0);
    destroy(animals);
    ...
    highest.clear(); track.clear();
    create("inp33.txt", animals, track);
    race(animals, track, highest);
    ...
    highest.clear(); track.clear();
    create("inp34.txt", animals, track);
    race(animals, track, highest);
